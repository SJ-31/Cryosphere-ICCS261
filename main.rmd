...
```{r, comment=NA}
pi_evenness %>%
  select(c("Barrow mountain high", "Barrow mountain low", "Bihor mountains", "Catriona snow")) %>%
  kruskal.test()
```
...
- **Conclusion:** many of the sites share the same taxa, but the relationships between them differ
...
**Conclusion**: There is a high degree of pathway diversity between sites, and the most distinct are the Catriona snow and Greenland ice sites.
- Again, the New Zealand soil site is clustered nearby with many other cryospheric sites
